...
Constructor TfrmRenamer.Create(AOwner: TComponent);
Begin
...
Destructor TfrmRenamer.Destroy;
Begin
  FreeAndNil(fmeGrid);
...
Procedure TfrmRenamer.FormActivate(Sender: TObject);
Var
  sFolder: String;
Begin
  Inherited;
...
Procedure TfrmRenamer.FormCloseQuery(Sender: TObject; Var CanClose: Boolean);
Begin
...
Procedure TfrmRenamer.RefreshUI;
Var
...
Procedure TfrmRenamer.SetStatus(AValue: String);
Var
  sStatus: String;
Begin
...
Procedure TfrmRenamer.btnSelectAllClick(Sender: TObject);
Var
  oBookmark: TBookMark;
Begin
  FDataset := TagManager.Dataset;
...
Procedure TfrmRenamer.btnInvertClick(Sender: TObject);
Var
  bSelected: Boolean;
  oBookmark: TBookMark;
Begin
...
Procedure TfrmRenamer.btnCaseRenameClick(Sender: TObject);
Var
  oBookmark: TBookMark;
  sPath: String;
...
Procedure TfrmRenamer.btnClearSelectionClick(Sender: TObject);
Begin
  fmeGrid.grdSQL.SelectedRows.Clear;
End;

Procedure TfrmRenamer.btnConvertVideoClick(Sender: TObject);
Var
...
Procedure TfrmRenamer.btnExportClick(Sender: TObject);
Var
  sExt: String;
  oExporter: TExporter;
Begin
...
Procedure TfrmRenamer.btnRecalcCountClick(Sender: TObject);
Var
  oList: TPathCount;
  oBookmark: TBookMark;
  sPath: String;
...
Procedure TfrmRenamer.btnRefreshClick(Sender: TObject);
Begin
  SetRootpath(FRootpath, FFilter);
End;

Procedure TfrmRenamer.ConfirmChangeFolder(AFolder, AFilter: String);
Var
  oDlg: TdlgScanFolder;
Begin
...
Procedure TfrmRenamer.btnLoadFolderClick(Sender: TObject);
Begin
  ConfirmChangeFolder(FRootpath, FFilter);
End;

Procedure TfrmRenamer.GridStartDrag(Sender: TObject);
Var
  oFiles: TStringList;
...
Procedure TfrmRenamer.SetRootPath(AFolder, AMask: String);
Begin
...
Procedure TfrmRenamer.tmrRefreshUITimer(Sender: TObject);
Begin
...
Procedure TfrmRenamer.LoadLocalSettings(oInifile: TIniFile);
Begin
...
Procedure TfrmRenamer.SaveLocalSettings(oInifile: TIniFile);
Begin
...
Procedure TfrmRenamer.UpdateOptions(FFormOption: TFormOptions);
Begin
...
Function TfrmRenamer.RenameFile(AOriginal, ADestination: String): Boolean;
Var
